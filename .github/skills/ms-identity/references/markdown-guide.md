# Markdown Guide / Long-form `.md` Reference (ms-identity)
...
Field rules (MS-specific differences from `your-org-ds/markdown-guide.md`):

| Field | Required | MS Format |
|---|---|---|
| `title` | yes | Sentence case |
| `description` | yes | One sentence |
| `author` | yes | `Frontier Cockpit Team` (not `Frontier Cockpit Team, AI-Native Software Engineer`) |
| `role` | yes | `Software Global Black Belt` (always English, never abbreviated) |
| `contact` | yes | `frontier-cockpit@example.com` (single channel) |
...
|---------|------------|-------------|---------|
| 1.0.0   | 2026-04-27 | Frontier Cockpit Team | Initial workshop guide |
...
Same as `your-org-ds/markdown-guide.md`:
...
- [ ] Frontmatter has `author`, `role` (`Software Global Black Belt`), `contact` (`frontier-cockpit@example.com`)
- [ ] No `github`, `linkedin`, `site` fields in frontmatter
- [ ] No `AI-Native Software Engineer` anywhere in the file
- [ ] No `@your-org`, `your-handle`, `example` anywhere
