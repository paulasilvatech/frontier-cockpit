...
The your-org icon system. Icons are inline SVG (never external files), monoline (1.5px stroke at 24x24 viewBox), and use `currentColor` so they inherit text color.
