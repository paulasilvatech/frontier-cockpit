# Brand Voice (ms-identity)

Same voice as your-org: professional but warm, didactic, technically precise, provocative when warranted by data. The MS-identity material has slightly more formal framing (it represents Microsoft externally), but the underlying voice is the same person.
