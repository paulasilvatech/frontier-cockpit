# Excel (ms-identity Office standard)

The full Excel standard for Microsoft-identity data deliverables: workbooks that open on a formula-driven dashboard, with KPI cards, native charts, metrics, and short explanations. This is the depth behind the short Excel section in `office.md`. Use it whenever you build, restyle, or audit an `.xlsx` for Frontier Cockpit Team.
...
5. **A footer**: 8.5pt italic gray, the source and `Frontier Cockpit Team, Software Global Black Belt, Microsoft` plus a confidentiality note.
...
- **Author** and **lastModifiedBy**: `Frontier Cockpit Team, Software Global Black Belt`
...
4. Author is `Frontier Cockpit Team, Software Global Black Belt`; title, subject, keywords set.
...
- Personal socials or the deprecated `Frontier Cockpit` role string.
