...
Style overrides for your-org (apply via `%%{init: ...}%%` directive):
...
The signature your-org architecture viz: stacked layers with the four DS colors, optional accent badges per layer.
