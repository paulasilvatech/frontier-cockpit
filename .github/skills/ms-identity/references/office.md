# Office Format Reference (ms-identity)
...
- Footer shows `Frontier Cockpit Team | Software Global Black Belt | frontier-cockpit@example.com`
...
- Workbook properties: Author = `Frontier Cockpit Team, Software Global Black Belt`
...
## Email (Outlook signature for ms-identity)
...
- Never use `Microsoft Americas` or `Frontier Cockpit` (deprecated), always `Software Global Black Belt`
