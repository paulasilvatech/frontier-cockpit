#!/usr/bin/env python3
"""
build_pptx.py: ms-identity HTML deck -> native, fully editable PowerPoint.
...
# ============================================================
# DESIGN TOKENS: mirror the ms-identity deck --ps-color-* set
# ============================================================
...
BRAND_TEXT = "Frontier Cockpit Team | Software Global Black Belt"
...
def r_cover(prs, ctx, c, page, total):
    ...
    meta = [("labels.author", "Frontier Cockpit Team"),
...
def main():
    ap = argparse.ArgumentParser(description="ms-identity HTML deck -> native editable PPTX.")
