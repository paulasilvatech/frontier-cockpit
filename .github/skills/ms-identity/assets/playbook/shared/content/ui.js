/* ============================================================
   ms-identity playbook, UI strings (chrome, modals, nav)
   v1.7.0, EN + PT-BR + ES
   Identity-locked strings (Frontier Cockpit Team, Software Global Black Belt,
   tagline, frontier-cockpit@example.com) are NOT in this file.
