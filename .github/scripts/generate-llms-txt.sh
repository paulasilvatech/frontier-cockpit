...

{
  ...
  printf 'This repository contains Frontier Cockpit, a local-to-enterprise observability package for GitHub Copilot. It combines Frontier Cockpit Local for local private optimization with Frontier Cockpit Hybrid for sanitized Azure rollups, governance, adoption, and leadership views.\n\n'
  ...
  printf '```bash\n'
  printf 'local-otel/client-bootstrap.sh\n'
  printf 'local-otel/check-workshop-local.sh\n'
  printf '```\n\n'
  ...
  printf '%s\n' '- `docs/FrontierCockpit_Requirements_v1_0_0_2026-07-02_en.md`'
  printf '%s\n' '- `docs/FrontierCockpit_DockerDesktopFrontendRequirements_v1_0_0_2026-06-25_en.md`'
  printf '%s\n' '- `docs/FrontierCockpit_PythonAspireLocalArchitecture_v1_0_0_2026-06-18_en.md`'
  printf '%s\n' '- `workshop/README.md`'
